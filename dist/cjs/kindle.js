...
exports.Kindle = exports.HttpClient = void 0;
const fetch_books_js_1 = require("./fetch-books.js");
const http_client_js_1 = require("./http-client.js");
var http_client_js_2 = require("./http-client.js");
Object.defineProperty(exports, "HttpClient", { enumerable: true, get: function () { return http_client_js_2.HttpClient; } });
class Kindle {
    ...
    static async baseRequest(client, version, args) {
        ...
        do {
            const url = (0, fetch_books_js_1.toUrl)(query, filter);
            const { books, sessionId, paginationToken } = await (0, fetch_books_js_1.fetchBooks)(client, url, version);
